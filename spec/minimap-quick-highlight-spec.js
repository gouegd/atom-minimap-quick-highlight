var MinimapQuickHighlight = require('../lib/minimap-quick-highlight');

describe("MinimapQuickHighlight", function() {
  var editor,
      ref,
      workspaceElement;
  ...
  beforeEach(function() {
    ...
    return waitsForPromise(function() {
      return atom.packages.activatePackage('minimap-quick-highlight');
    });
  });
